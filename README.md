...
- Taking into account the movie count observed above for movies of different genres where e.g. Dramas accounted for more than half of the movies in the database
